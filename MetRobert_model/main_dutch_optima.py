...
from transformers import AutoModel, get_linear_schedule_with_warmup, RobertaTokenizer, logging
...
optuna_tweak_hidden_layers = True
...
def train_me(
    ...
    if optuna_tweak_learning_rate == True:
        lear_rate = trial.suggest_float('lear_rate', 7e-5, 8.5e-5)
