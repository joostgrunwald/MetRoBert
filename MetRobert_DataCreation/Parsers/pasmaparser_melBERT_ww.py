                ...
                for child_of_child in child:
                    ...
                    if (child_of_child.get('s') == "UNKNOWN"):
                        for child3 in child_of_child:
                            ...
                            if (True == True):
                                ...
                                # ? Het correct taggen van voornaamwoorden
                                    ...
                                    pos_tag = "DET"
                                elif "VNW(" in child3.get('pos') and "pron" in child3.get('pos') and str(child3.get('word')).lower() is not 'het':
                                    pos_tag = "PRON"
                        ...
                        # ? Het correct taggen van voornaamwoorden
                            ...
                            pos_tag = "DET"
                        elif "VNW(" in child_of_child.get('pos') and "pron" in child_of_child.get('pos') and str(child_of_child.get('word')).lower() is not 'het':
                            pos_tag = "PRON"
