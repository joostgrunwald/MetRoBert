...
y2_pred_110 = f1_model.predict(np.array([110]).reshape(1, -1))
y2_pred_120 = f1_model.predict(np.array([120]).reshape(1, -1))
y2_pred_130 = f1_model.predict(np.array([130]).reshape(1, -1))
y2_pred_140 = f1_model.predict(np.array([140]).reshape(1, -1))
y2_pred_150 = f1_model.predict(np.array([150]).reshape(1, -1))
...
# predict using logaritmic model
f1_pred2_110 = 45.9291 + 7.1536 * np.log(110)
f1_pred2_120 = 45.9291 + 7.1536 * np.log(120)
f1_pred2_130 = 45.9291 + 7.1536 * np.log(130)
f1_pred2_140 = 45.9291 + 7.1536 * np.log(140)
f1_pred2_150 = 45.9291 + 7.1536 * np.log(150)
...
#full model
print("outputs for acc")
print((y_pred_110 + acc_pred_110)/2)
print((y_pred_120 + acc_pred_120)/2)
print((y_pred_130 + acc_pred_130)/2)
print((y_pred_140 + acc_pred_140)/2)
print((y_pred_150 + acc_pred_150)/2)
print("outputs for f1")
print((y2_pred_110 + f1_pred2_110)/2)
print((y2_pred_120 + f1_pred2_120)/2)
print((y2_pred_130 + f1_pred2_130)/2)
print((y2_pred_140 + f1_pred2_140)/2)
print((y2_pred_150 + f1_pred2_150)/2)
